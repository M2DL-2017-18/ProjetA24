...
public class Controller {
	...
	/**
	 * Demande la cr�ation de la fourmi 
	 * 
	 */
	...
	public void selectFood() {
		this.entityType = 1;
		TextInputDialog dialog = new TextInputDialog("1");
		dialog.setTitle("Quantit� de nourriture ?");
		dialog.setHeaderText("Combien d'unit�s de nourriture voulez vous poser ?");
		dialog.setContentText("Nb : ");
	...
	/**
	 * Permet de mettre � jour l'interface graphique
	 */
